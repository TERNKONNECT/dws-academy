      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            />
            <p className="text-xs text-muted-foreground">Shown below your name on course pages</p>
          </div>
          <div className="space-y-2">
            <Label>Bio</Label>
            <Textarea
            ...
            />
            <p className="text-xs text-muted-foreground">Shown on your course pages</p>
          </div>
